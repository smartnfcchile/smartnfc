...
export default function PhysicalDesignsClient({ cards, templates, designs, initialCardId }: { cards: Card[]; templates: Template[]; designs: Design[]; initialCardId?: string }) {
  ...
  return <div className="physical-designs-screen space-y-8">
    <section className="physical-design-picker rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-4 sm:p-6 shadow-sm">
