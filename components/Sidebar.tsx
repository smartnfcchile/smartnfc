    ...
    <>
      ...
      <div className="lg:hidden flex items-center justify-between p-4 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white w-full sticky top-0 z-50">
        ...
        <button
          ...
          className="p-2 rounded-lg bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-800 dark:text-white text-lg focus:outline-none focus:ring-2 focus:ring-blue-600"
        >
          {isOpen ? "✕" : "☰"}
        </button>
      </div>
      ...
      {/* Menú Lateral */}
      <aside
        className={`fixed top-0 bottom-0 left-0 w-64 bg-white/90 dark:bg-slate-950/90 backdrop-blur-md border-r border-slate-200 dark:border-slate-900 text-slate-800 dark:text-white flex flex-col justify-between z-40 transition-transform duration-300 lg:translate-x-0 ${
      ...
      >
        ...
        <div className="space-y-6">
          <div className="hidden lg:block px-3">
            ...
            <span className="text-[10px] uppercase font-bold text-slate-400 dark:text-slate-500 block tracking-widest mt-1">
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold tracking-wide transition-all ${
                      isActive
                        ...
                        : "text-slate-650 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-900/50"
                    }`}
                  >
        ...
        <div className="space-y-4 pt-6 border-t border-slate-200 dark:border-slate-900 px-2">
          <div className="flex flex-col">
            <span className="font-bold text-slate-800 dark:text-slate-200 truncate text-sm">
              {user.name || "Usuario"}
            </span>
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold tracking-wide text-red-600 dark:text-red-400 hover:text-red-500 hover:bg-red-500/10 transition-all border border-transparent hover:border-red-200 dark:hover:border-red-500/20"
          >
            <span>🚪</span>
