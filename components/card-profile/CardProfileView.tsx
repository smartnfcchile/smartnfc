...
// Contrato de datos estrictamente tipado (Requisito 2)
...
// Funciones Auxiliares Puras del Renderizador
...
const getTemplateBgColor = (template: string): string => {
  if (template === "corporate-4") return "#fdfaf6";
  if (template === "personal-1") return "#fafafa";
  if (template === "personal-5") return "#f7f2ea";
  if (template === "business-3") return "#eef6f9";
  if (template === "business-4") return "#f3f4f6";
  if (template === "creator-3") return "#f1f5f9";
  return "#0f172a";
};

const getPhotoStyleConfig = (
  styleName?: string | null
): { className: string; style: React.CSSProperties } => {
  let classes = "h-32 w-32 relative overflow-hidden bg-slate-900 border-2 ";
  const styles: React.CSSProperties = {};

  switch (styleName) {
    case "diamond":
      classes += "border-slate-300 shadow-lg hover:rotate-6 transition duration-300";
      styles.transform = "rotate(-4deg)";
      styles.borderRadius = "20%";
      break;
    case "hexagon":
      classes += "border-slate-400/40 shadow-md";
      styles.clipPath = "polygon(25% 0%, 75% 0%, 100% 50%, 75% 100%, 25% 100%, 0% 50%)";
      styles.borderRadius = "0px";
      break;
    case "shield":
      classes += "border-slate-350 shadow-md";
      styles.clipPath = "polygon(0 0, 100% 0, 100% 70%, 50% 100%, 0 70%)";
      styles.borderRadius = "0px";
      break;
    case "soft-square":
      classes += "rounded-3xl border-slate-300 shadow-md";
      break;
    case "rounded-border":
...
END:VCARD`;
  ...
  // Formateo de canales de contacto con su respectivo interruptor de visibilidad
  ...
  // Filtrado de enlaces sociales con sus respectivos interruptores de visibilidad
  const socialLinks = [
  ...
  // Determinar el estilo del banner de portada
  ...
  if (template === "corporate-2") {
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-full ring-4 ring-amber-500/80 ring-offset-4 ring-offset-slate-900 bg-slate-955 text-4xl font-black text-white shadow-xl shadow-amber-500/10 overflow-hidden";
    ...
    sectionContainerClass = "mx-6 mt-7 rounded-3xl border border-amber-500/10 bg-slate-955/60 px-5 py-5";
    ...
    secondaryBtnClass = "rounded-2xl border border-amber-500/40 bg-slate-955/90 px-4 py-4 text-center text-sm font-bold text-amber-200 shadow-sm transition hover:bg-slate-900 hover:border-amber-400 w-full";
    smallSecondaryBtnClass = "rounded-2xl border border-slate-800 bg-slate-955/80 px-4 py-3 text-center text-sm font-bold text-slate-350 transition hover:bg-slate-900 w-full";
    socialBtnClass = "rounded-full border border-slate-800 bg-slate-955 px-4 py-2 text-xs font-bold text-slate-450 transition hover:bg-slate-900 hover:text-amber-300";
    documentBtnClass = "flex w-full items-center justify-between rounded-2xl border border-slate-800 bg-slate-955/80 px-4 py-4 text-sm font-bold text-slate-200 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md hover:bg-slate-900";
    videoContainerClass = "mx-6 mt-7 rounded-3xl border border-amber-500/10 bg-slate-955/60 p-4";
    ...
    mainClass = "min-h-screen bg-slate-955 text-white flex items-center justify-center px-4 py-8 relative overflow-hidden transition-colors duration-300";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-full border-4 border-double border-amber-500/60 bg-slate-955 text-4xl font-black text-white shadow-lg overflow-hidden";
    ...
    sectionContainerClass = "mx-6 mt-7 rounded-2xl border border-slate-800 bg-slate-955/50 px-5 py-5";
    ...
    primaryBtnClass = "rounded-2xl px-4 py-4 text-center text-sm font-bold text-amber-400 shadow-md transition hover:-translate-y-0.5 w-full flex items-center justify-center gap-2 cursor-pointer bg-slate-955 border border-amber-500/30 hover:bg-slate-900 hover:border-amber-400";
    secondaryBtnClass = "rounded-2xl px-4 py-4 text-center text-sm font-bold text-slate-955 shadow-lg transition hover:-translate-y-0.5 w-full bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 font-black shadow-amber-500/20 hover:brightness-110 cursor-pointer";
    ...
    socialBtnClass = "rounded-xl border border-slate-800 bg-slate-955 px-4 py-2 text-xs font-bold text-slate-400 transition hover:bg-slate-900 hover:text-white";
    documentBtnClass = "flex w-full items-center justify-between rounded-xl border border-slate-800 bg-slate-955 px-4 py-4 text-sm font-bold text-slate-200 shadow-sm transition hover:-translate-y-0.5 hover:bg-slate-900";
    videoContainerClass = "mx-6 mt-7 rounded-2xl border border-slate-800 bg-slate-955/50 p-4";
    videoTitleClass = "mt-2 text-base font-bold text-white";
    videoIframeWrapperClass = "mt-3 overflow-hidden rounded-2xl border border-slate-800 bg-black";
    footerClass = "mt-8 border-t border-slate-800/80 px-6 py-6 text-center";
    locationClass = "text-xs text-slate-505";
    ...
    mainClass = "min-h-screen bg-[#fdfaf6] text-amber-955 transition-colors duration-300 flex items-center justify-center px-4 py-8 relative overflow-hidden";
    articleClass = "w-full max-w-md overflow-hidden rounded-[2rem] border border-[#dfd0b0] bg-[#f9f5eb]/90 backdrop-blur-md shadow-xl shadow-amber-955/5 relative z-10";
    ...
    mainClass = "min-h-screen bg-slate-955 text-white transition-colors duration-300 flex items-center justify-center px-4 py-8 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-slate-955 to-black relative overflow-hidden";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-full border-2 border-slate-700 bg-slate-955 text-4xl font-black text-white shadow-lg overflow-hidden";
    profileLabelClass = "mt-6 text-[10px] font-extrabold uppercase tracking-[0.3em] text-slate-400";
    profileNameClass = "mt-3 text-3xl font-black tracking-tight text-white";
    profileRoleClass = "mt-2 text-sm font-semibold text-slate-300";
    profileCompanyClass = "mt-1 text-xs font-semibold text-slate-400";
    ...
    secondaryBtnClass = "rounded-2xl border border-amber-500/40 bg-slate-955 px-4 py-4 text-center text-sm font-bold text-amber-300 shadow-sm transition hover:bg-slate-900 hover:border-amber-400 w-full";
    smallSecondaryBtnClass = "rounded-2xl border border-slate-800 bg-slate-955 px-4 py-3 text-center text-sm font-bold text-slate-200 transition hover:bg-slate-900 w-full";
    socialBtnClass = "rounded-full border border-slate-800 bg-slate-955 px-4 py-2 text-xs font-bold text-slate-400 transition hover:bg-slate-900 hover:text-white";
    documentBtnClass = "flex w-full items-center justify-between rounded-2xl border border-slate-800 bg-slate-955 px-4 py-4 text-sm font-bold text-slate-250 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md hover:bg-slate-900";
    videoContainerClass = "mx-6 mt-7 rounded-3xl border border-slate-800/80 bg-slate-955/40 p-4";
    videoTitleClass = "mt-2 text-base font-bold text-white";
    videoIframeWrapperClass = "mt-3 overflow-hidden rounded-2xl border border-slate-800 bg-black";
    footerClass = "mt-8 border-t border-slate-800/80 px-6 py-6 text-center";
    locationClass = "text-xs text-slate-505";
    poweredByClass = "mt-3 text-[9px] font-extrabold uppercase tracking-[0.2em] text-slate-550";
    linkSectionLabelClass = "mb-3 text-[10px] font-extrabold uppercase tracking-[0.2em] text-slate-400";
    ...
    profileCompanyClass = "mt-1 text-xs font-semibold text-slate-505";
    sectionContainerClass = "mx-6 mt-7 rounded-xl border border-slate-300 bg-[#f4f4f5] px-5 py-5";
    sectionLabelClass = "text-[10px] font-extrabold uppercase tracking-[0.2em] text-slate-505";
    ...
    locationClass = "text-xs text-slate-505";
    poweredByClass = "mt-3 text-[9px] font-extrabold uppercase tracking-[0.2em] text-slate-505";
    linkSectionLabelClass = "mb-3 text-[10px] font-extrabold uppercase tracking-[0.2em] text-slate-505";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-full border-4 border-white/20 bg-slate-955 text-4xl font-black text-white shadow-xl overflow-hidden";
    ...
    profileCompanyClass = "mt-1 text-xs font-semibold text-slate-400";
    sectionContainerClass = "mx-6 mt-7 rounded-3xl border border-white/5 bg-slate-955/40 px-5 py-5";
    sectionLabelClass = "text-[10px] font-extrabold uppercase tracking-[0.2em] text-violet-400";
    sectionTextClass = "mt-2.5 text-sm leading-6 text-slate-300";
    primaryBtnClass = "rounded-2xl px-4 py-4 text-center text-sm font-bold text-white shadow-md transition hover:-translate-y-0.5 w-full flex items-center justify-center gap-2 cursor-pointer bg-gradient-to-r from-violet-650 to-indigo-650 hover:from-violet-500 hover:to-indigo-500 shadow-violet-500/20";
    secondaryBtnClass = "rounded-2xl border border-white/10 bg-slate-955/80 px-4 py-4 text-center text-sm font-bold text-slate-200 shadow-sm transition hover:bg-slate-900 w-full";
    smallSecondaryBtnClass = "rounded-2xl border border-white/10 bg-slate-955/80 px-4 py-3 text-center text-sm font-bold text-slate-200 transition hover:bg-slate-900 w-full";
    socialBtnClass = "rounded-full border border-white/10 bg-slate-955 px-4 py-2 text-xs font-bold text-slate-400 transition hover:bg-slate-900 hover:text-white";
    documentBtnClass = "flex w-full items-center justify-between rounded-2xl border border-white/10 bg-slate-955/85 px-4 py-4 text-sm font-bold text-slate-200 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md hover:bg-slate-900";
    videoContainerClass = "mx-6 mt-7 rounded-3xl border border-white/5 bg-slate-955/40 p-4";
    videoTitleClass = "mt-2 text-base font-bold text-white";
    ...
    profileRoleClass = "mt-2 text-sm font-semibold text-slate-200";
    profileCompanyClass = "mt-1 text-xs font-semibold text-slate-400";
    sectionContainerClass = "mx-6 mt-7 rounded-3xl border border-slate-800 bg-slate-955/40 px-5 py-5";
    ...
    smallSecondaryBtnClass = "rounded-2xl border border-slate-800 bg-[#1d2226] px-4 py-3 text-center text-sm font-bold text-slate-250 transition hover:bg-slate-955 w-full";
    socialBtnClass = "rounded-full border border-slate-800 bg-[#1d2226] px-4 py-2 text-xs font-bold text-slate-450 transition hover:bg-slate-955 hover:text-white";
    ...
    videoContainerClass = "mx-6 mt-7 rounded-3xl border border-slate-800 bg-slate-955/40 p-4";
    videoTitleClass = "mt-2 text-base font-bold text-white";
    videoIframeWrapperClass = "mt-3 overflow-hidden rounded-2xl border border-slate-800 bg-black";
    footerClass = "mt-8 border-t border-slate-800/80 px-6 py-6 text-center";
    locationClass = "text-xs text-slate-500";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-full border-4 border-pink-500/50 bg-slate-955 text-4xl font-black text-white shadow-lg overflow-hidden";
    profileLabelClass = "mt-6 text-[10px] font-extrabold uppercase tracking-[0.3em] text-pink-500";
    profileNameClass = "mt-3 text-3xl font-black tracking-tight text-white";
    profileRoleClass = "mt-2 text-sm font-semibold text-slate-300";
    profileCompanyClass = "mt-1 text-xs font-semibold text-slate-505";
    sectionContainerClass = "mx-6 mt-7 rounded-3xl border border-slate-800/80 bg-slate-955/60 px-5 py-5";
    ...
    secondaryBtnClass = "rounded-2xl border border-slate-800 bg-slate-955 px-4 py-4 text-center text-sm font-bold text-slate-200 shadow-sm transition hover:bg-slate-900 w-full";
    smallSecondaryBtnClass = "rounded-2xl border border-slate-800 bg-slate-955 px-4 py-3 text-center text-sm font-bold text-slate-250 transition hover:bg-slate-900 w-full";
    socialBtnClass = "rounded-2xl border border-pink-500/30 bg-slate-955 px-4 py-2.5 text-xs font-bold text-pink-400 transition hover:border-pink-500 hover:text-white";
    documentBtnClass = "flex w-full items-center justify-between rounded-2xl border border-slate-800 bg-slate-955/80 px-4 py-4 text-sm font-bold text-slate-200 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md hover:bg-slate-900";
    videoContainerClass = "mx-6 mt-7 rounded-3xl border border-slate-850 bg-slate-955/60 p-4";
    videoTitleClass = "mt-2 text-base font-bold text-white";
    videoIframeWrapperClass = "mt-3 overflow-hidden rounded-2xl border border-slate-800 bg-black";
    footerClass = "mt-8 border-t border-slate-800/80 px-6 py-6 text-center";
    locationClass = "text-xs text-slate-500";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-full border-4 border-emerald-500 bg-slate-955 text-4xl font-black text-white shadow-xl overflow-hidden";
    ...
    profileCompanyClass = "mt-1 text-xs font-semibold text-slate-400";
    sectionContainerClass = "mx-6 mt-7 rounded-3xl border border-emerald-500/10 bg-slate-955/60 px-5 py-5";
    ...
    secondaryBtnClass = "rounded-2xl border border-emerald-500/30 bg-slate-955 px-4 py-4 text-center text-sm font-bold text-emerald-300 shadow-sm transition hover:bg-slate-900 w-full";
    smallSecondaryBtnClass = "rounded-2xl border border-slate-800 bg-slate-955/80 px-4 py-3 text-center text-sm font-bold text-slate-350 transition hover:bg-slate-900 w-full";
    socialBtnClass = "rounded-full border border-slate-800 bg-slate-955 px-4 py-2 text-xs font-bold text-slate-450 transition hover:bg-slate-900 hover:text-emerald-400";
    documentBtnClass = "flex w-full items-center justify-between rounded-2xl border border-slate-800 bg-slate-955/80 px-4 py-4 text-sm font-bold text-slate-250 shadow-sm transition hover:-translate-y-0.5 hover:bg-slate-900";
    videoContainerClass = "mx-6 mt-7 rounded-3xl border border-emerald-500/10 bg-slate-955/60 p-4";
    videoTitleClass = "mt-2 text-base font-bold text-white";
    videoIframeWrapperClass = "mt-3 overflow-hidden rounded-2xl border border-slate-800 bg-black";
    footerClass = "mt-8 border-t border-slate-800/80 px-6 py-6 text-center";
    locationClass = "text-xs text-slate-500";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-full border-4 border-[#c7a75c] bg-slate-955 text-4xl font-black text-white shadow-xl overflow-hidden";
    profileLabelClass = "mt-6 text-[10px] font-extrabold uppercase tracking-[0.3em] text-[#c7a75c]";
    profileNameClass = "mt-3 text-3xl font-black tracking-tight text-white";
    profileRoleClass = "mt-2 text-sm font-semibold text-[#c7a75c]";
    profileCompanyClass = "mt-1 text-xs font-semibold text-slate-400";
    sectionContainerClass = "mx-6 mt-7 rounded-3xl border border-[#c7a75c]/10 bg-slate-955/60 px-5 py-5";
    sectionLabelClass = "text-[10px] font-extrabold uppercase tracking-[0.2em] text-[#c7a75c]";
    sectionTextClass = "mt-2.5 text-sm leading-6 text-slate-200";
    primaryBtnClass = "rounded-2xl px-4 py-5 text-center text-sm font-black tracking-wider text-slate-955 shadow-md transition hover:-translate-y-0.5 w-full flex items-center justify-center gap-2 cursor-pointer bg-[#c7a75c] hover:bg-[#b0934f] uppercase";
    secondaryBtnClass = "rounded-2xl border border-[#c7a75c]/50 bg-slate-955 px-4 py-4 text-center text-sm font-bold text-[#c7a75c] shadow-sm transition hover:bg-[#c7a75c]/10 w-full";
    smallSecondaryBtnClass = "rounded-2xl border border-slate-800 bg-slate-955/80 px-4 py-3 text-center text-sm font-bold text-slate-300 transition hover:bg-slate-900 w-full";
    socialBtnClass = "rounded-full border border-slate-800 bg-slate-955 px-4 py-2 text-xs font-bold text-slate-450 transition hover:bg-slate-900 hover:text-[#c7a75c]";
    documentBtnClass = "flex w-full items-center justify-between rounded-2xl border border-slate-800 bg-slate-955/80 px-4 py-4 text-sm font-bold text-slate-250 shadow-sm transition hover:-translate-y-0.5 hover:bg-slate-900";
    videoContainerClass = "mx-6 mt-7 rounded-3xl border border-[#c7a75c]/10 bg-slate-955/60 p-4";
    videoTitleClass = "mt-2 text-base font-bold text-white";
    videoIframeWrapperClass = "mt-3 overflow-hidden rounded-2xl border border-slate-800 bg-black";
    footerClass = "mt-8 border-t border-slate-800/80 px-6 py-6 text-center";
    locationClass = "text-xs text-slate-500";
    ...
    articleClass = "w-full max-w-md overflow-hidden rounded-[2rem] border border-red-655/15 bg-zinc-900/90 backdrop-blur-md shadow-2xl shadow-black relative z-10";
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-full border-4 border-red-600 bg-slate-955 text-4xl font-black text-white shadow-xl overflow-hidden";
    profileLabelClass = "mt-6 text-[10px] font-extrabold uppercase tracking-[0.3em] text-red-505";
    profileNameClass = "mt-3 text-3xl font-black tracking-tight text-white";
    profileRoleClass = "mt-2 text-sm font-semibold text-red-400";
    profileCompanyClass = "mt-1 text-xs font-semibold text-slate-400";
    sectionContainerClass = "mx-6 mt-7 rounded-3xl border border-red-655/10 bg-zinc-955/60 px-5 py-5";
    sectionLabelClass = "text-[10px] font-extrabold uppercase tracking-[0.2em] text-red-505";
    sectionTextClass = "mt-2.5 text-sm leading-6 text-slate-200";
    primaryBtnClass = "rounded-2xl px-4 py-5 text-center text-sm font-black text-white shadow-md transition hover:-translate-y-0.5 w-full flex items-center justify-center gap-2 cursor-pointer bg-red-600 hover:bg-red-700 shadow-red-655/20";
    secondaryBtnClass = "rounded-2xl border border-red-500/40 bg-slate-955 px-4 py-4 text-center text-sm font-bold text-red-400 shadow-sm transition hover:bg-zinc-905 w-full";
    smallSecondaryBtnClass = "rounded-2xl border border-zinc-800 bg-slate-955/80 px-4 py-3 text-center text-sm font-bold text-slate-355 transition hover:bg-zinc-905 w-full";
    socialBtnClass = "rounded-full border border-zinc-800 bg-slate-955 px-4 py-2 text-xs font-bold text-slate-450 transition hover:bg-zinc-905 hover:text-red-500";
    documentBtnClass = "flex w-full items-center justify-between rounded-2xl border border-zinc-800 bg-slate-955/80 px-4 py-4 text-sm font-bold text-slate-200 shadow-sm transition hover:-translate-y-0.5 hover:bg-zinc-905";
    videoContainerClass = "mx-6 mt-7 rounded-3xl border border-red-655/10 bg-zinc-955/60 p-4";
    videoTitleClass = "mt-2 text-base font-bold text-white";
    ...
    locationClass = "text-xs text-slate-500";
    poweredByClass = "mt-3 text-[9px] font-extrabold uppercase tracking-[0.2em] text-red-505/80";
    linkSectionLabelClass = "mb-3 text-[10px] font-extrabold uppercase tracking-[0.2em] text-red-505";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-full border-4 border-indigo-500 bg-slate-955 text-4xl font-black text-white shadow-xl overflow-hidden";
    ...
    sectionTextClass = "mt-2.5 text-sm leading-6 text-slate-200";
    primaryBtnClass = "rounded-2xl px-4 py-5 text-center text-sm font-black text-white shadow-md transition hover:-translate-y-0.5 w-full flex items-center justify-center gap-2 cursor-pointer bg-gradient-to-r from-indigo-500 to-purple-650 shadow-indigo-500/20";
    secondaryBtnClass = "rounded-2xl border border-indigo-500/40 bg-slate-955 px-4 py-4 text-center text-sm font-bold text-indigo-300 shadow-sm transition hover:bg-[#0c0820] w-full";
    smallSecondaryBtnClass = "rounded-2xl border border-slate-800/80 bg-slate-955/80 px-4 py-3 text-center text-sm font-bold text-slate-355 transition hover:bg-[#0c0820] w-full";
    socialBtnClass = "rounded-full border border-slate-800/80 bg-slate-955 px-4 py-2 text-xs font-bold text-slate-450 transition hover:bg-[#0c0820] hover:text-[#c7a75c]";
    documentBtnClass = "flex w-full items-center justify-between rounded-2xl border border-slate-850 bg-slate-955/80 px-4 py-4 text-sm font-bold text-slate-200 shadow-sm transition hover:bg-[#0c0820]";
    ...
    footerClass = "mt-8 border-t border-slate-855/80 px-6 py-6 text-center";
    locationClass = "text-xs text-slate-500";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-full border-4 border-amber-500 bg-slate-955 text-4xl font-black text-white shadow-xl overflow-hidden";
    profileLabelClass = "mt-6 text-[10px] font-extrabold uppercase tracking-[0.3em] text-amber-505";
    profileNameClass = "mt-3 text-3xl font-black tracking-tight text-white";
    ...
    sectionLabelClass = "text-[10px] font-extrabold uppercase tracking-[0.2em] text-amber-505";
    sectionTextClass = "mt-2.5 text-sm leading-6 text-slate-200";
    ...
    secondaryBtnClass = "rounded-2xl border border-amber-500/40 bg-slate-955 px-4 py-4 text-center text-sm font-bold text-amber-350 shadow-sm transition hover:bg-[#0d0907] w-full";
    smallSecondaryBtnClass = "rounded-2xl border border-slate-800/80 bg-slate-955/80 px-4 py-3 text-center text-sm font-bold text-slate-350 transition hover:bg-[#0d0907] w-full";
    socialBtnClass = "rounded-full border border-slate-800/80 bg-slate-955 px-4 py-2 text-xs font-bold text-slate-400 transition hover:bg-[#0d0907] hover:text-[#c7a75c]";
    documentBtnClass = "flex w-full items-center justify-between rounded-2xl border border-slate-800 bg-slate-955/80 px-4 py-4 text-sm font-bold text-[#c7a75c] shadow-sm transition hover:bg-[#0d0907]";
    ...
    locationClass = "text-xs text-slate-500";
    poweredByClass = "mt-3 text-[9px] font-extrabold uppercase tracking-[0.2em] text-amber-505/80";
    linkSectionLabelClass = "mb-3 text-[10px] font-extrabold uppercase tracking-[0.2em] text-amber-505";
    ...
    profileRoleClass = "mt-2 text-sm font-semibold text-amber-400";
    profileCompanyClass = "mt-1 text-xs font-semibold text-slate-400";
    sectionContainerClass = "mx-6 mt-7 rounded-3xl border border-amber-600/10 bg-slate-955/60 px-5 py-5";
    sectionLabelClass = "text-[10px] font-extrabold uppercase tracking-[0.2em] text-amber-505";
    sectionTextClass = "mt-2.5 text-sm leading-6 text-slate-200";
    primaryBtnClass = "rounded-2xl px-4 py-4 text-center text-sm font-bold text-slate-955 shadow-md transition hover:-translate-y-0.5 w-full flex items-center justify-center gap-2 cursor-pointer bg-gradient-to-r from-amber-500 to-orange-500 font-extrabold hover:brightness-110 shadow-amber-500/10";
    secondaryBtnClass = "rounded-2xl border border-amber-500/30 bg-slate-955 px-4 py-4 text-center text-sm font-bold text-amber-300 shadow-sm transition hover:bg-slate-900 w-full";
    smallSecondaryBtnClass = "rounded-2xl border border-slate-800 bg-slate-955/80 px-4 py-3 text-center text-sm font-bold text-slate-300 transition hover:bg-slate-900 w-full";
    socialBtnClass = "rounded-full border border-slate-800 bg-slate-955 px-4 py-2 text-xs font-bold text-slate-455 transition hover:bg-slate-900 hover:text-amber-505";
    documentBtnClass = "flex w-full items-center justify-between rounded-2xl border border-slate-800 bg-slate-955/80 px-4 py-4 text-sm font-bold text-slate-200 shadow-sm transition hover:-translate-y-0.5 hover:bg-slate-900";
    videoContainerClass = "mx-6 mt-7 rounded-3xl border border-amber-600/10 bg-slate-955/60 p-4";
    videoTitleClass = "mt-2 text-base font-bold text-white";
    videoIframeWrapperClass = "mt-3 overflow-hidden rounded-2xl border border-slate-800 bg-black";
    footerClass = "mt-8 border-t border-slate-800/80 px-6 py-6 text-center";
    locationClass = "text-xs text-slate-500";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-2xl border-4 border-yellow-555 bg-[#111] text-4xl font-black text-white shadow-xl overflow-hidden";
    ...
    secondaryBtnClass = "rounded-xl border border-yellow-500/30 bg-[#111] px-4 py-4 text-center text-sm font-bold text-yellow-455 shadow-sm transition hover:bg-zinc-900 w-full";
    ...
    socialBtnClass = "rounded-xl border border-zinc-800 bg-[#111] px-4 py-2.5 text-xs font-bold text-slate-400 transition hover:bg-zinc-900 hover:text-yellow-550";
    documentBtnClass = "flex w-full items-center justify-between rounded-xl border border-zinc-800 bg-[#111] px-4 py-4 text-sm font-bold text-slate-205 shadow-sm transition hover:bg-zinc-900";
    ...
    footerClass = "mt-8 border-t border-zinc-850/80 px-6 py-6 text-center";
    locationClass = "text-xs text-slate-500";
    poweredByClass = "mt-3 text-[9px] font-extrabold uppercase tracking-[0.2em] text-yellow-550/80";
    linkSectionLabelClass = "mb-3 text-[10px] font-extrabold uppercase tracking-[0.2em] text-yellow-555";
    ...
    profileCompanyClass = "mt-1 text-xs font-semibold text-slate-505";
    sectionContainerClass = "mx-6 mt-7 rounded-3xl border border-sky-50 bg-sky-55/50 px-5 py-5";
    ...
    primaryBtnClass = "rounded-2xl px-4 py-4 text-center text-sm font-bold text-white shadow-md transition hover:-translate-y-0.5 w-full flex items-center justify-center gap-2 cursor-pointer bg-sky-500 hover:bg-sky-650";
    secondaryBtnClass = "rounded-2xl border border-sky-200 bg-white px-4 py-4 text-center text-sm font-bold text-sky-600 shadow-sm transition hover:bg-sky-55 w-full";
    smallSecondaryBtnClass = "rounded-2xl border border-slate-100 bg-white px-4 py-3 text-center text-sm font-bold text-slate-600 transition hover:bg-sky-55 w-full";
    socialBtnClass = "rounded-full border border-sky-100 bg-white px-4 py-2 text-xs font-bold text-sky-500 transition hover:bg-sky-55 hover:text-sky-600";
    documentBtnClass = "flex w-full items-center justify-between rounded-2xl border border-sky-100 bg-white px-4 py-4 text-sm font-bold text-slate-600 shadow-sm transition hover:bg-sky-55";
    videoContainerClass = "mx-6 mt-7 rounded-3xl border border-sky-50 bg-sky-55/50 p-4";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-full border-2 border-slate-300 bg-white text-4xl font-black text-slate-805 shadow-sm overflow-hidden";
    profileLabelClass = "mt-6 text-[10px] font-extrabold uppercase tracking-[0.3em] text-slate-505";
    ...
    sectionLabelClass = "text-[10px] font-extrabold uppercase tracking-[0.2em] text-slate-505";
    sectionTextClass = "mt-2.5 text-sm leading-6 text-slate-605";
    ...
    videoContainerClass = "mx-6 mt-7 rounded-2xl border border-slate-100 bg-slate-55 p-4";
    videoTitleClass = "mt-2 text-base font-bold text-slate-909";
    videoIframeWrapperClass = "mt-3 overflow-hidden rounded-xl border border-slate-200 bg-black";
    footerClass = "mt-8 border-t border-slate-100 px-6 py-6 text-center";
    locationClass = "text-xs text-slate-505";
    poweredByClass = "mt-3 text-[9px] font-extrabold uppercase tracking-[0.2em] text-slate-505/80";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-full border-4 border-[#d4af37] bg-slate-955 text-4xl font-black text-white shadow-xl overflow-hidden";
    ...
    profileCompanyClass = "mt-1 text-xs font-semibold text-slate-450";
    sectionContainerClass = "mx-6 mt-7 rounded-3xl border border-slate-800 bg-slate-955/60 px-5 py-5";
    sectionLabelClass = "text-[10px] font-extrabold uppercase tracking-[0.2em] text-[#d4af37]";
    sectionTextClass = "mt-2.5 text-sm leading-6 text-slate-200";
    primaryBtnClass = "rounded-2xl px-4 py-5 text-center text-sm font-black text-slate-950 shadow-md transition hover:-translate-y-0.5 w-full flex items-center justify-center gap-2 cursor-pointer bg-gradient-to-r from-amber-400 to-[#d4af37] shadow-amber-505/10";
    secondaryBtnClass = "rounded-2xl border border-[#d4af37]/50 bg-slate-955 px-4 py-4 text-center text-sm font-bold text-[#d4af37] shadow-sm transition hover:bg-[#d4af37]/10 w-full";
    smallSecondaryBtnClass = "rounded-2xl border border-slate-800 bg-slate-955/80 px-4 py-3 text-center text-sm font-bold text-slate-355 transition hover:bg-slate-900 w-full";
    socialBtnClass = "rounded-full border border-slate-800 bg-slate-955 px-4 py-2 text-xs font-bold text-slate-400 transition hover:bg-slate-900 hover:text-[#d4af37]";
    documentBtnClass = "flex w-full items-center justify-between rounded-2xl border border-slate-800 bg-slate-955/80 px-4 py-4 text-sm font-bold text-[#d4af37] shadow-sm transition hover:-translate-y-0.5 hover:bg-slate-900";
    videoContainerClass = "mx-6 mt-7 rounded-3xl border border-[#d4af37]/10 bg-slate-955/60 p-4";
    videoTitleClass = "mt-2 text-base font-bold text-white";
    videoIframeWrapperClass = "mt-3 overflow-hidden rounded-2xl border border-slate-805 bg-black";
    footerClass = "mt-8 border-t border-slate-800/80 px-6 py-6 text-center";
    locationClass = "text-xs text-slate-500";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-2xl border-4 border-orange-500 bg-zinc-909 text-white font-bold overflow-hidden shadow-lg";
    ...
    sectionTextClass = "mt-2.5 text-sm leading-6 text-slate-350";
    primaryBtnClass = "rounded-xl px-4 py-4 text-center text-sm font-black text-slate-950 shadow-md transition hover:-translate-y-0.5 w-full flex items-center justify-center gap-2 cursor-pointer bg-orange-500 hover:bg-orange-606 uppercase shadow-orange-505/10";
    secondaryBtnClass = "rounded-xl border border-orange-555/30 bg-zinc-955 px-4 py-4 text-center text-sm font-bold text-orange-450 shadow-sm transition hover:bg-zinc-900 w-full";
    smallSecondaryBtnClass = "rounded-xl border border-zinc-800 bg-zinc-955 px-4 py-3 text-center text-sm font-bold text-slate-300 transition hover:bg-zinc-900 w-full";
    socialBtnClass = "rounded-xl border border-zinc-800 bg-zinc-955 px-4 py-2.5 text-xs font-bold text-slate-455 transition hover:bg-[#1a1a1a] hover:text-orange-500";
    documentBtnClass = "flex w-full items-center justify-between rounded-xl border border-zinc-800 bg-zinc-955 px-4 py-4 text-sm font-bold text-slate-200 shadow-sm transition hover:bg-zinc-900";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-full border-4 border-yellow-500 bg-slate-955 text-white font-bold overflow-hidden shadow-lg";
    profileLabelClass = "mt-6 text-[10px] font-extrabold uppercase tracking-[0.3em] text-yellow-500";
    profileNameClass = "mt-3 text-3xl font-black tracking-tight text-white";
    profileRoleClass = "mt-2 text-sm font-semibold text-emerald-400";
    profileCompanyClass = "mt-1 text-xs font-semibold text-slate-400";
    sectionContainerClass = "mx-6 mt-7 rounded-3xl border border-emerald-500/10 bg-emerald-955/20 px-5 py-5";
    sectionLabelClass = "text-[10px] font-extrabold uppercase tracking-[0.2em] text-yellow-505";
    sectionTextClass = "mt-2.5 text-sm leading-6 text-slate-200";
    primaryBtnClass = "rounded-2xl px-4 py-4 text-center text-sm font-bold text-slate-955 shadow-md transition hover:-translate-y-0.5 w-full flex items-center justify-center gap-2 cursor-pointer bg-gradient-to-r from-yellow-400 to-amber-500 hover:brightness-110 shadow-yellow-505/10";
    secondaryBtnClass = "rounded-2xl border border-emerald-500/30 bg-emerald-955/40 px-4 py-4 text-center text-sm font-bold text-emerald-300 shadow-sm transition hover:bg-emerald-950 w-full";
    smallSecondaryBtnClass = "rounded-2xl border border-slate-800 bg-emerald-955/30 px-4 py-3 text-center text-sm font-bold text-slate-350 transition hover:bg-emerald-900 w-full";
    ...
    videoContainerClass = "mx-6 mt-7 rounded-3xl border border-emerald-500/10 bg-emerald-955/20 p-4";
    videoTitleClass = "mt-2 text-base font-bold text-white";
    videoIframeWrapperClass = "mt-3 overflow-hidden rounded-2xl border border-slate-850 bg-black";
    footerClass = "mt-8 border-t border-slate-850/80 px-6 py-6 text-center";
    locationClass = "text-xs text-slate-500";
    poweredByClass = "mt-3 text-[9px] font-extrabold uppercase tracking-[0.2em] text-yellow-505/80";
    ...
    articleClass = "w-full max-w-md overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl relative z-10";
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-full border-4 border-indigo-650 bg-white text-indigo-755 font-bold overflow-hidden shadow-md";
    ...
    profileCompanyClass = "mt-1 text-xs font-semibold text-slate-455";
    sectionContainerClass = "mx-6 mt-7 rounded-2xl border border-slate-100 bg-slate-55 px-5 py-5";
    ...
    secondaryBtnClass = "rounded-xl border border-indigo-200 bg-white px-4 py-4 text-center text-sm font-bold text-indigo-600 shadow-sm transition hover:bg-indigo-55 w-full";
    smallSecondaryBtnClass = "rounded-xl border border-slate-200 bg-white px-4 py-3 text-center text-sm font-bold text-slate-600 transition hover:bg-slate-50 w-full";
    socialBtnClass = "rounded-full border border-slate-200 bg-white px-4 py-2 text-xs font-bold text-slate-500 transition hover:bg-slate-100 hover:text-indigo-655";
    documentBtnClass = "flex w-full items-center justify-between rounded-xl border border-slate-200 bg-white px-4 py-4 text-sm font-bold text-slate-600 shadow-sm transition hover:bg-slate-55";
    videoContainerClass = "mx-6 mt-7 rounded-2xl border border-slate-100 bg-slate-55 p-4";
    videoTitleClass = "mt-2 text-base font-bold text-[#0f172a]";
    videoIframeWrapperClass = "mt-3 overflow-hidden rounded-xl border border-slate-200 bg-black";
    footerClass = "mt-8 border-t border-slate-100 px-6 py-6 text-center";
    locationClass = "text-xs text-slate-500";
    poweredByClass = "mt-3 text-[9px] font-extrabold uppercase tracking-[0.2em] text-indigo-655/80";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-2xl border-2 border-fuchsia-500 bg-slate-955 text-white font-bold overflow-hidden shadow-lg";
    ...
    sectionTextClass = "mt-2.5 text-sm leading-6 text-slate-200";
    primaryBtnClass = "rounded-2xl px-4 py-4 text-center text-sm font-bold text-white shadow-md transition hover:-translate-y-0.5 w-full flex items-center justify-center gap-2 cursor-pointer bg-gradient-to-r from-fuchsia-600 to-pink-600 hover:brightness-110 shadow-fuchsia-606/20";
    secondaryBtnClass = "rounded-2xl border border-fuchsia-500/40 bg-slate-955 px-4 py-4 text-center text-sm font-bold text-fuchsia-350 shadow-sm transition hover:bg-slate-900 w-full";
    smallSecondaryBtnClass = "rounded-2xl border border-slate-800 bg-slate-955/80 px-4 py-3 text-center text-sm font-bold text-slate-300 transition hover:bg-slate-900 w-full";
    socialBtnClass = "rounded-full border border-slate-855 bg-slate-955 px-4 py-2 text-xs font-bold text-slate-455 transition hover:bg-[#160a23] hover:text-fuchsia-400";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-2xl border-4 border-blue-550 bg-slate-955 text-white font-bold overflow-hidden shadow-lg";
    profileLabelClass = "mt-6 text-[10px] font-extrabold uppercase tracking-[0.3em] text-blue-550";
    profileNameClass = "mt-3 text-3xl font-black tracking-tight text-white";
    profileRoleClass = "mt-2 text-sm font-semibold text-blue-400";
    profileCompanyClass = "mt-1 text-xs font-semibold text-slate-400";
    sectionContainerClass = "mx-6 mt-7 rounded-2xl border border-blue-900/20 bg-blue-955/20 px-5 py-5";
    sectionLabelClass = "text-[10px] font-extrabold uppercase tracking-[0.2em] text-blue-455";
    sectionTextClass = "mt-2.5 text-sm leading-6 text-slate-350";
    primaryBtnClass = "rounded-xl px-4 py-4 text-center text-sm font-bold text-white shadow-md transition hover:-translate-y-0.5 w-full flex items-center justify-center gap-2 cursor-pointer bg-blue-655 hover:bg-blue-500 shadow-blue-655/20";
    secondaryBtnClass = "rounded-xl border border-blue-500/30 bg-[#080b11] px-4 py-4 text-center text-sm font-bold text-blue-455 shadow-sm transition hover:bg-blue-955 w-full";
    ...
    socialBtnClass = "rounded-full border border-slate-805 bg-[#080b11] px-4 py-2 text-xs font-bold text-slate-400 transition hover:bg-[#0c1018] hover:text-blue-400";
    documentBtnClass = "flex w-full items-center justify-between rounded-xl border border-slate-800 bg-[#080b11] px-4 py-4 text-sm font-bold text-slate-205 shadow-sm transition hover:bg-blue-955";
    ...
    footerClass = "mt-8 border-t border-slate-850/80 px-6 py-6 text-center";
    locationClass = "text-xs text-slate-500";
    poweredByClass = "mt-3 text-[9px] font-extrabold uppercase tracking-[0.2em] text-blue-455/80";
    linkSectionLabelClass = "mb-3 text-[10px] font-extrabold uppercase tracking-[0.2em] text-blue-400";
  } else {
    mainClass = "min-h-screen bg-slate-950 text-white flex items-center justify-center px-4 py-8 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-slate-955 to-black relative overflow-hidden transition-colors duration-300";
    ...
    avatarContainerClass = "mx-auto flex h-28 w-28 items-center justify-center rounded-full border-2 border-amber-500/60 bg-slate-955 text-4xl font-black text-white shadow-lg overflow-hidden";
    profileLabelClass = "mt-6 text-[10px] font-extrabold uppercase tracking-[0.3em] text-slate-400";
    profileNameClass = "mt-3 text-3xl font-black tracking-tight text-white";
    profileRoleClass = "mt-2 text-sm font-semibold text-amber-400";
    profileCompanyClass = "mt-1 text-xs font-semibold text-slate-400";
    ...
    sectionLabelClass = "text-[10px] font-extrabold uppercase tracking-[0.2em] text-slate-400";
    sectionTextClass = "mt-2.5 text-sm leading-6 text-slate-300";
    primaryBtnClass = "rounded-2xl px-4 py-4 text-center text-sm font-bold text-slate-955 shadow-md transition hover:-translate-y-0.5 w-full flex items-center justify-center gap-2 cursor-pointer bg-gradient-to-r from-amber-500 to-yellow-600 font-extrabold hover:brightness-110 shadow-amber-500/10";
    ...
    smallSecondaryBtnClass = "rounded-2xl border border-slate-800 bg-slate-955/60 px-4 py-3 text-center text-sm font-bold text-slate-300 transition hover:bg-slate-900 w-full";
    socialBtnClass = "rounded-full border border-slate-800 bg-slate-955 px-4 py-2 text-xs font-bold text-slate-400 transition hover:bg-slate-900 hover:text-amber-400 hover:border-amber-500/30";
    documentBtnClass = "flex w-full items-center justify-between rounded-2xl border border-slate-800 bg-slate-955/50 px-4 py-4 text-sm font-bold text-slate-200 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md hover:bg-slate-900/80";
    videoContainerClass = "mx-6 mt-7 rounded-3xl border border-slate-800/80 bg-slate-955/40 p-4";
    videoTitleClass = "mt-2 text-base font-bold text-white";
    videoIframeWrapperClass = "mt-3 overflow-hidden rounded-2xl border border-slate-800 bg-black";
    footerClass = "mt-8 border-t border-slate-800/80 px-6 py-6 text-center";
        ...
        {isBusiness ? (
                ...
                <div className="flex flex-col items-center">
                  ...
                  {template === "business-4" && (
                    <>
                      ...
                      <span className="text-amber-505/80 font-sans tracking-[0.3em] text-[8px] font-extrabold uppercase mt-0.5">
                        HOTEL BOUTIQUE
                      </span>
                    </>
                  )}
          ...
          <div className={`${showCover ? "h-auto" : "h-32"} w-full relative bg-slate-800`}>
            {showCover ? (
              ...
              <div className="w-full h-full relative bg-gradient-to-r from-slate-900 via-indigo-955 to-slate-900 flex items-end">
          ...
          <section className={`mx-6 mt-5 p-4 rounded-2xl border flex items-center gap-4 text-left ${
            ...
            <div>
              <p className={`text-[9px] font-bold uppercase tracking-wider ${
                isLightTemplate ? "text-slate-505" : "text-slate-400"
              }`}>
                Representante Comercial
              </p>
              <h3 className={`text-sm font-bold ${
                isLightTemplate ? "text-slate-909" : "text-white"
              }`}>
